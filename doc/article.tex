...
The numerator is $\le 1$, where the equality occurs when there are no selection criteria.
If $p(data|model)$ is a multi-dimensional normal distribution, the numerator is
the sum of error functions.

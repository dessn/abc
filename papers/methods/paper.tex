...
Having laid out each individual aspect of the model, the relationships between variables and our treatment of uncertainty, here we summarise the relationships in our model likelihood mathematically. In this likelihood summary, we leave out sample selection for simplicity. Our likelihood is thus given as:

\begin{align}
&P({\rm data}|\theta) = \notag \\
&\int\, d\mu\, d\eta \ P( \hat{\eta}, \hat{\mathcal{C}}_\eta^{-1} | \eta, \delta \mathcal{Z}_i, \kappa_0, \kappa_1) P(\hat{z}|z) \notag \\

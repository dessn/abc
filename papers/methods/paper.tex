...
For the sample size of the DES and LowZ supernova samples (of order 350 supernova), the bias from intrinsic scatter models is sub-dominant to the statistical uncertainty, as shown in Figure \ref{fig:bulk_posterior}. {\green For our full systematics model, the bias represents a deviation between $0\sigma$ to $0.5\sigma$ depending on scatter model, and as such we will leave more complicated treatment of them for future work.}
...
{\red Introduce BBC. Highlight its use on Panstars}

{\red have plots for w-w comparison for g10 and c11}

{\red conclude that correlation is good, yay, have extra uncertainty, but this can be explained from previous section}

BHM Mean for G10: -0.998, BBC mean -1.042, average diff -0.044, difference scatter 0.057

BHM Mean for C11: -0.945, BBC mean -0.978, average diff -0.033, difference scatter 0.062

{\red For systematics paper, also find 60\% reduction in uncert using planck priors}

\begin{table}
	\centering
	\caption{Good table right here. Yeah boi.}

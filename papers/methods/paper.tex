...
\author{
	...
	R.~Kessler\altaffilmark{2},
	C.~Lidman\altaffilmark{4},
	A.~M\"oller\altaffilmark{5,4},
	M.~Sako\altaffilmark{6},
	D.~Scolnic\altaffilmark{2},
	M.~Smith\altaffilmark{7} 
...
\affil{$^{2}$ Kavli Institute for Cosmological Physics, University of Chicago, Chicago, IL 60637, USA}
...
\affil{$^{6}$ Department of Physics and Astronomy, University of Pennsylvania, Philadelphia, PA 19104, USA}
\affil{$^{7}$ School of Physics and Astronomy, University of Southampton,  Southampton, SO17 1BJ, UK}
...
\begin{deluxetable}{ll}
	...
	\\
	& \textbf{Input Data}\textsuperscript{a} \\

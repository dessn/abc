...
\begin{table}
	...
	\begin{tabular}{l|cc}
		...
		\hline
		{\gten} Stat + Syst  &  $-1.03\pm 0.10\ (0.08)$ & $0.3\sigma$  \\
		{\celeven} Stat + Syst  &  $-0.97\pm 0.09\ (0.06)$ & $0.3\sigma$  \\
		{\gten}  Stat         &  $-1.01\pm 0.08\ (0.08)$ & $0.1\sigma$   \\
		{\celeven} Stat         &  $-0.96\pm 0.07\ (0.05)$ & $0.6\sigma$   \\
		\hline
	\end{tabular}
\end{table}

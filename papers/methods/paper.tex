...
\author{
	...
	R.~Kessler\altaffilmark{4},
	C.~Lidman\altaffilmark{5},
	A.~M\"oller\altaffilmark{6,5},
	M.~Sako\altaffilmark{3},
	D.~Scolnic\altaffilmark{4},
	M.~Smith\altaffilmark{7},
	R.~C.~Wolf\altaffilmark{8}
...
\affil{$^{4}$ Kavli Institute for Cosmological Physics, University of Chicago, Chicago, IL 60637, USA}
\affil{$^{5}$ The Research School of Astronomy and Astrophysics, Australian National University, ACT 2601, Australia}
\affil{$^{6}$ ARC Centre of Excellence for All-sky Astrophysics (CAASTRO)}
\affil{$^{7}$ School of Physics and Astronomy, University of Southampton,  Southampton, SO17 1BJ, UK}
\affil{$^{8}$ Department of Physics, Stanford University, 382 Via Pueblo Mall, Stanford, CA 94305, USA}

...
\documentclass[a4paper,fleqn,usenatbib]{emulateapj}
...
\title{\name: A hierarchical Bayesian model for Supernova Cosmology}
 ...
 \author{
 	S.~R.~Hinton\altaffilmark{1,2},\thanks{E-mail: samuelreay@gmail.com}
 	T.~M.~Davis\altaffilmark{1,2},
 	A.~G.~Kim\altaffilmark{3},
 	A.~M\"oller\altaffilmark{2,4},
 	M.~Sako\altaffilmark{5},
 	M.~Smith\altaffilmark{6},
 	\\}
 ...
 \affil{$^{3}$ Lawrence Berkeley National Laboratory, 1 Cyclotron Road, Berkeley, CA 94720, USA}
 \affil{$^{4}$ The Research School of Astronomy and Astrophysics, Australian National University, ACT 2601, Australia}
 \affil{$^{5}$ Department of Physics and Astronomy, University of Pennsylvania, Philadelphia, PA 19104, USA}
 \affil{$^{6}$ School of Physics and Astronomy, University of Southampton,  Southampton, SO17 1BJ, UK}

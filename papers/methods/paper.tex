...
\begin{table*}
	...
	\begin{tabular}{l|rrrrr}
		...
		{\celeven} Stat + Syst  &  $0.002, \ 0.009\ (0.007)$ & $-0.04, \ 0.15\ (0.13)$ & $-19.351, \ 0.030\ (0.018)$ & $0.024, \ 0.016\ (0.011)$ & $0.029, \ 0.020\ (0.014)$ \\
		{\celeven} Stat         &  $0.000, \ 0.008\ (0.007)$ & $-0.05, \ 0.16\ (0.13)$ & $-19.359, \ 0.016\ (0.015)$ & $0.025, \ 0.016\ (0.012)$ & $0.027, \ 0.020\ (0.015)$\\
		\hline
	\end{tabular}
\end{table*}
...
\begin{table}
	...
	\end{tabular}
\end{table}
\footnotetext{This value is computed with each simulation having the same weight. It disagrees with the value provided in \citet[Table 10, row 3]{Brout18SYS} which uses inverse variance weighted averages. We do not utilise this weight because the variance is correlated with the value of $w$ due to the $\Omega_m$ prior applied in the fitting process.} 
\begin{figure}
	\begin{center}

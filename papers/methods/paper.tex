...
{\green Unfortunately, the assumption of Gaussian uncertainty is incorrect - the errors reported by the light curve fitting process on $m_B$, $x_1$ and $c$ are not accurate. The intrinsic supernovae population is commonly described in terms of coherent magnitude dispersion and in chromatic dispersion, where respectively some supernovae are uniformly brighter or dimmer than the population mean, and the spectral energy density of the supernovae varies non-uniformly as a function of wavelength. The presence of chromatic smearing in the intrinsic supernova population \citep{Guy2010, Chotard2011} means the summary statistics reported from light curve fitting are under-reported, not Gaussian and equation \eqref{eq:pop} is violated. We address this in two ways - increasing the reported uncertainty, and allowing for a global shift in observed colour.}

...
w_{\rm LowZ} &= \mathcal{N}\left( \frac{m_B^* - \mu_{\rm LowZ}}{\sqrt{\sigma^{*2}_{m_B} + \sigma_{\rm LowZ}^2}}\right) \times \notag\\
...
\begin{figure}
	...
	\end{center}
	\caption{Parameter summaries for 20 realisations of supernova data with the Flat $\Lambda$CDM model.}.

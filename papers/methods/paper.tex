...
\begin{table}
	...
	\begin{tabular}{l|cc}
		...
		Model & $\Omega_m$ & $w$ \\ 
		\hline
		Flat $\Lambda$CDM & $0.302\pm 0.015$ & -- \\ 
		Flat $w$CDM + $\Omega_m$ prior & $\left( 300.9\pm7.4 \right) \times 10^{-3}$ & $-0.996\pm 0.038$ \\ 
		\hline
	\end{tabular}
\end{table}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=\columnwidth]{bulk_small_g10.pdf}		\includegraphics[width=\columnwidth]{bulk_small_c11.pdf}
	\end{center}
	\caption{Posterior surfaces for 100 realisations of supernova data for two intrinsic dispersion models - the {\gten} model for the top panel and the {\celeven} model for the bottom panel. Surfaces for $\Omega_m$, $w$, $\alpha$, $\beta$ and $\langle M_B \rangle$ are shown, with the other fit parameters being marginalised over. The intrinsic scatter model has significant impact on the recovered $\beta$, which in itself effects cosmology, resulting in small biases in $w$.}

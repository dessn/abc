...
if __name__ == "__main__":
    ...
    # ]
    simulations = [
        [SNANASimulation(ndes, "DES3YR_DES_BULK_G10_SKEW", kappa=0),
         SNANASimulation(nlowz, "DES3YR_LOWZ_BULK_G10_SKEW", kappa=0)],
        [SNANASimulation(ndes, "DES3YR_DES_BULK_G10_SKEW", kappa=3),
         SNANASimulation(nlowz, "DES3YR_LOWZ_BULK_G10_SKEW", kappa=3)],
        [SNANASimulation(ndes, "DES3YR_DES_BULK_G10_SKEW", kappa=-3),
         SNANASimulation(nlowz, "DES3YR_LOWZ_BULK_G10_SKEW", kappa=-3)],
    ]

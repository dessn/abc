...
if __name__ == "__main__":
    ...
    simulation = [SNANASysSimulation(500, sys_index=4, sim="lowz", manual_selection=[13.70+0.5, 1.363, 3.8, 0.2]),
                  SNANASysSimulation(500, sys_index=4, sim="des", manual_selection=[22.3, 0.7, None, 1.0])]

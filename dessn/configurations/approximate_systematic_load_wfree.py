...
if __name__ == "__main__":
    ...
    c.configure(label_font_size=10, tick_font_size=10, diagonal_tick_labels=False, linestyles=ls,
                colors=colors, shade_alpha=alphas, shade=True, flip=False, bar_shade=True)
    ...
    c.plotter.plot_summary(filename=[pfn + "_summary.png", pfn + "_summary.pdf"], parameters=params,
                           truth="Stat only", extra_parameter_spacing=1)

...
if __name__ == "__main__":
    ...
    simulation = [SNANABulkSimulation(100, sim="SHINTON_LOWZ_MATRIX_G10_SYMC_SYMX1", manual_selection=[13.70+0.5, 1.363, 3.8, 0.2], num_calib=58),
                  SNANABulkSimulation(250, sim="SHINTON_DES_MATRIX_G10_SYMC_SYMX1", manual_selection=[22.12, 0.544, None, 1.0], num_calib=22)]

...
if __name__ == "__main__":
    ...
    model = ApproximateModelOl(systematics_scale=0.001)
    ...
    if h != "smp-hk5pn72":  # The hostname of my laptop. Only will work for me, ha!
        ...
        c1.configure(spacing=1.0, diagonal_tick_labels=False, sigma2d=False, contour_labels="confidence", summary=False,
                     plot_hists=False)
        c2.configure(spacing=1.0, diagonal_tick_labels=False, sigma2d=False, contour_labels="confidence", summary=False,
                     plot_hists=False)
        ...
        c1.plotter.plot(filename=[pfn + "_cosmo.png", pfn + "_cosmo.pdf"], truth=truth, parameters=parameters,
                        figsize=(5, 7), extents=[[0.1, 0.95], [0.1, 1.5]], chains="Combined")

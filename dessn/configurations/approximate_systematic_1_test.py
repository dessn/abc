...
if __name__ == "__main__":
    ...
    simulation = [SNANASysSimulation(300, sys_index=1, sim="lowz", manual_selection=[13.70+0.5, 1.363, 3.8, 0.2]),
                  SNANASysSimulation(250, sys_index=1, sim="des", manual_selection=[22.5, 0.7, None, 1.0])]

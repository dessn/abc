...
if __name__ == "__main__":
    ...
    simulation = [SNANACombinedBulk(200, ["SHINTON_LOWZ_MATRIX_G10_SKEWC_SKEWX1", "SHINTON_LOWZ_MATRIX_C11_SKEWC_SKEWX1"],
                                    "CombinedLowZ", manual_selection=[13.70, 1.4+0.2, 3.8, 0.2], num_calib=58),
                  SNANACombinedBulk(200, ["SHINTON_DES_MATRIX_G10_SKEWC_SKEWX1", "SHINTON_DES_MATRIX_C11_SKEWC_SKEWX1"],

...
from dessn.framework.simulations.snana import SNANASimulationGauss0p3, SNANASimulationLowzGauss0p3, \
    SNANASimulationIdeal0p3, SNANASimulationIdealLowZ0p3
...
if __name__ == "__main__":
    ...
    simulation = SNANASimulationIdealLowZ0p3(500, num_nodes=num_nodes, manual_selection=[15.5, 1.0, None, 1.0])
    # simulation = SNANASimulationLowzGauss0p3(500, num_nodes=num_nodes)

    # lowzs, dess = simulation
    # print(lowzs.get_approximate_correction(plot=True))
    print(simulation.get_approximate_correction())

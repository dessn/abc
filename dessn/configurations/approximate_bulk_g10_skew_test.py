...
if __name__ == "__main__":
    ...
    simulation = [SNANABulkSimulation(152, sim="SHINTON_LOWZ_MATRIX_G10_SKEWC_SKEWX1", manual_selection=lowz_sel(), num_calib=50),
                  SNANABulkSimulation(208, sim="SHINTON_DES_MATRIX_G10_SKEWC_SKEWX1", manual_selection=des_sel(), num_calib=21)]

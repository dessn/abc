...
if __name__ == "__main__":
    ...
    simulation = [SNANABulkSimulation(300, sim="SHINTON_LOWZ_MATRIX_C11_SYMC_SYMX1", manual_selection=lowz_sel(), num_calib=58),
                  SNANABulkSimulation(250, sim="SHINTON_DES_MATRIX_C11_SYMC_SYMX1", manual_selection=des_sel(), num_calib=22)]

...
if __name__ == "__main__":
    ...
    convert("SHINTON_LOWZ_MATRIX_G10_SKEWC_SKEW1",    "bulk/LOWZ_MATRIX.NML")
    convert("SHINTON_LOWZ_MATRIX_G10_SYMC_SYMX1",     "bulk/LOWZ_MATRIX.NML")
    convert("SHINTON_LOWZ_MATRIX_SMEAR_SKEWC_SKEWX1", "bulk/LOWZ_MATRIX.NML")
    convert("SHINTON_LOWZ_MATRIX_SMEAR_SYMC_SYMX1",   "bulk/LOWZ_MATRIX.NML")
    ...
    convert("SHINTON_DES_MATRIX_G10_SKEWC_SKEW1",     "bulk/DES_MATRIX.NML")
    convert("SHINTON_DES_MATRIX_G10_SYMC_SYMX1",      "bulk/DES_MATRIX.NML")
    convert("SHINTON_DES_MATRIX_SMEAR_SKEWC_SKEWX1",  "bulk/DES_MATRIX.NML")
    convert("SHINTON_DES_MATRIX_SMEAR_SYMC_SYMX1",    "bulk/DES_MATRIX.NML")

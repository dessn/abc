...
def get_truths_labels_significance():
    ...
    result = [
        ...
        ("alpha", 0.14, r"$\alpha$", True, 0, 0.5),
        ("beta", 3.1, r"$\beta$", True, 0, 5),
        ("mean_MB", -19.365, r"$\langle M_B \rangle$", True, -19.6, -19),
        ("mean_x1", np.zeros(2), r"$\langle x_1^{%d} \rangle$", True, None, None),
        ("mean_c", np.zeros(2), r"$\langle c^{%d} \rangle$", True, None, None),
        ...
        ("alpha_c", np.zeros(2), r"$\alpha_c^{%d}$", True, None, None),

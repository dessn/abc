...
if __name__ == "__main__":
    ...
    td = dir_name + "/../output/"
    plot_name = td + "plot_simple.png"
    plot_name_single = td + "plot_simple_single.png"
    plot_name_weight = td + "plot_simple_weight.png"
    plot_name_sep = td + "plot_simple_sep.png"
    walk_name = td + "plot_simple_walk.png"
